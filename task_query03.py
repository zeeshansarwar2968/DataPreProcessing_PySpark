...
if __name__ == "__main__":
    try:
        ...
        # Subtracting each user datetime value with the lowest value
        ...
        df2_02.coalesce(1).write.mode('overwrite').option("header", True).csv(
            "C:/Users/zeesh/Documents/AzureDataEngineer/outputs/query03")
        # input("========================================= Press any KEY ======================================= ")

        # Pushing the output file to Azure Blob Storage
        basepath = 'C:/Users/zeesh/Documents/AzureDataEngineer/outputs/query03'
        filelist = os.listdir(basepath)
        ts = time.time()
        print(filelist[2])
        print("Azure Blob Storage v" + __version__ + " - Python")
        blob_service_client = BlobServiceClient.from_connection_string(connect_str)
        blob_client = blob_service_client.get_blob_client(container="blobdefault6", blob=f"query03-{ts}.csv")
        with open(f"C:/Users/zeesh/Documents/AzureDataEngineer/outputs/query03/{filelist[2]}", "rb") as blob_file:
